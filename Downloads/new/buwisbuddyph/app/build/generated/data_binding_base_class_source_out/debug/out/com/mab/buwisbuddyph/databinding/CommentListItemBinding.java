...
public final class CommentListItemBinding implements ViewBinding {
  ...
  private CommentListItemBinding(@NonNull LinearLayout rootView, @NonNull TextView conversationTV,
      @NonNull TextView userFullName, @NonNull CircleImageView userProfileImage) {
  ...
  public static CommentListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CommentListItemBinding((LinearLayout) rootView, conversationTV, userFullName,
          userProfileImage);
    }

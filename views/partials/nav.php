        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700 hover:text-white" 
              aria-current="page">Home</a>

              <a href="/about" class="<?= urlIs('/about') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700 hover:text-white" 
